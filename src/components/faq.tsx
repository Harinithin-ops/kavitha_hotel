    ...
    <section aria-labelledby="faq-title">
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger>Do you offer Pure Veg options?</AccordionTrigger>
          <AccordionContent>
            Our menu features a wide range of authentic Pure Veg dishes, including specialty gravies and starters.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    </section>
